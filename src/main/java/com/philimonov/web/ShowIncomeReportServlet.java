...
public class ShowIncomeReportServlet extends AbstractServlet {

    private final CategoryService categoryService;

    public ShowIncomeReportServlet() {
    ...
    protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws IOException {
        ...
        if (personId.isPresent()) {
            ...
            if (from != null && to != null) {
                List<ReportCategoryDTO> reportsList = categoryService.getIncomeReportByCategory(from, to, personId.get());
